...
export default function Personajes() {
    ...
    useEffect(() => {
        axios.get(`${baseUrl}/characters?ts=1&apikey=d781254a480edce1c3a28770fb303244&hash=85e2f7ba75867851a2fb9d7ea4d5764a`)
            .then(response => {
                ...
                <div className="row text-uppercase mt-5">
                    {data.map((item) => (
                        <div className="mb-4 mx-5 p-2 col-3 text-center fw-bold">
                            <p style={{fontFamily:"Britannic bold",fontSize:"25px"}}>{item.name}</p>
